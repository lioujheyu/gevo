...
public:
	...
	CUmodule module;
	CUfunction kernel_dna_forces_edge_nonbonded;
	CUfunction kernel_dna_forces_edge_bonded;
	CUfunction kernel_sum_edge_forces_torques;
	CUfunction kernel_first_step_mixed;
	CUfunction kernel_second_step_mixed;
